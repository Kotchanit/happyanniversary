        ...
        <div className="w-full min-h-screen flex flex-col items-center justify-center bg-black relative overflow-hidden">
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                ...
                >
                    ...
                    >
                        {/* Text Animation */}
                        <div className="text-center max-w-3xl mx-auto bg-black/30 p-4 md:p-6 rounded-lg backdrop-blur-lg h-[80px] md:h-[72px] flex items-center justify-center overflow-hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full -mt-24">
